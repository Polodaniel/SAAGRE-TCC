...
namespace SAGRE.Controllers
{
    public class RelatorioCompletoController : Controller
    {
        ...
        public IActionResult BuscarBoletins(Filtro filtros)
        {
            ...
            string HTML_Pesquisa = MontaHTMLPesquisa(ListaAux);
        ...
        private List<BoletimModel> BuscaBoletinsFiltro(List<BoletimModel> lista, Filtro filtros)
        {
            ...
            if (!Equals(filtros.nomeavaliador, null))
                ListaAux = ListaAux.Where(x => x.NomeFiscal == filtros.nomeavaliador).ToList();
            ...
            {
                var Setor = _context.LocalModel.Where(x => x.ID == Convert.ToInt32(filtros.local) && x.Nome == filtros.nomelocal).Select(x => x.Setor.ID).FirstOrDefault();
        ...
        private string MontaHTMLPesquisa(List<BoletimModel> listaBoletim)
        {
            ...
            //sb.AppendLine("                         <thead class='thead-dark small'>                                                      ");
            //sb.AppendLine("                             <tr class='text-light bg-dark'>                                                   ");
            //sb.AppendLine("                                 <td>N° Boletim</td>                                                           ");
            //sb.AppendLine("                                 <td>Atividade Realizada</td>                                                  ");
            //sb.AppendLine("                                 <td class='text-center'>Análise Postura</td>                                  ");
            //sb.AppendLine("                                 <td>Análise Cognitiva</td>                                                    ");
            //sb.AppendLine("                                 <td>Análise Ambiente</td>                                                     ");
            //sb.AppendLine("                             </tr>                                                                             ");
            //sb.AppendLine("                         </thead>                                                                              ");
            //sb.AppendLine("                         <tbody class='small'>                                                                 ");
